            ...
            <View style = {styles.main}>
                <ScrollView style = {styles.scrollView}>
                    <View style = {styles.titleBox}>
                        ...
                        <Text style = {styles.return} onPress = { () => navigate('MainScreen') }>Return to main</Text>
                    </View>
                    <View style = {styles.paragraph}>
                        ...
                        <Text style = {styles.paragraphText}> </Text>
                        <Text style = {styles.paragraphText}>* Please note, this application is not a diagnostic tool and is not intended to substitute advice/support from a medical or mental health professional. Users experiencing frequent severe and acute stress responses should seek support from a medical professional [LIST SUPPORT RESOURCES ONCE MORE].</Text>
                    </View>
                </ScrollView>
            </View>
        );
